...
const vcard = 'BEGIN:VCARD\n' 
            + 'VERSION:3.0\n' 
            + 'FN:FoundzGanz Admin\n' 
            + 'ORG: Pengembang SagiriBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6289664550953:+62 896-6455-0953\n' 
            + 'END:VCARD' 
prefix = '#'
blocked = []   
limitawal = 30
...
/******** OWNER NUMBER**********/
const ownerNumber = ["6289664550953@s.whatsapp.net","6289664550953@s.whatsapp.net"] 
/************************************/
          ...
          const checkLimit = (sender) => {
           ...
           return false
            ...
            break
                ...
                addKoinUser('6289664550953@s.whatsapp.net', fee)
